(function () {
  ...
  function mostrarTareas() {
    ...
    arrayTareas.forEach((tarea) => {
      ...
      btnEstadoTarea.ondblclick = function () {
        // Crear una copia del objeto tarea para mutarlo(modificarlo)
  ...
  // Si un objeto esta vacío y busco algunas de sus propiedades no marcará undefined
  function mostrarFormulario(editar = false, tarea = {}) {
    ...
    modal.addEventListener("click", function (e) {
      ...
      // Para que detecte el evento del modal porque utilizamos inner-html
      ...
      if (e.target.classList.contains("submit-nueva-tarea")) {
        // Gracias a value puedo obtener lo que escribe el usuario y con trim quitar los espacios en blanco(al inicio y al final)
  ...
  function cambiarEstadoTarea(tarea) {
    // Aqui se modifica la copia del objeto "Tarea" sin modificar el original
